...
namespace SGP4_Sharp
{
  ...
  {
    public const Int64 TicksPerDay = 86400000000LL;
    public const Int64 TicksPerHour = 3600000000LL;
    public const Int64 TicksPerMinute = 60000000LL;
    public const Int64 TicksPerSecond = 1000000LL;
    public const Int64 TicksPerMillisecond = 1000LL;
    public const Int64 TicksPerMicrosecond = 1LL;

    public const Int64 UnixEpoch = 62135596800000000LL;
...
//      }
    ...
    public int DayOfWeek()
    {
      /*
           ...
           * 6 Saturday
           */
      return (int)(((m_encoded / TimeSpan.TicksPerDay) + 1LL) % 7LL);
    }
